		...
		<section className="2xl:max-container relative flex flex-col py-10 lg:mb-10 lg:py-20 xl:mb-20">
			<div className="hide-scrollbar flex h-[340px] w-full items-start justify-start gap-8 lg:h-[400px] xl:h-[640px]">
				<CampSite
					...
					subtitle="Botanical Garden in Vancouver, British Columbia"
					peopleJoined="1000+ Daily Users"
				/>
				<CampSite
			...
			<div className="flexEnd mt-10 px-6 lg:-mt-60 lg:mr-6">
				<div className="bg-blue-800 p-8 lg:max-w-[500px] xl:max-w-[734px] xl:rounded-5xl xl:px-16 xl:py-20 relative w-full overflow-hidden rounded-3xl">
					...
					<p className="regular-16 xl:regular-16 mt-5 text-white">
						Starting from the anxiety of getting an estimate when
						you're thinking about starting a new project, the
